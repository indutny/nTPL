...
this.parse = nTPL = (function() {	
	...
	*/
	this.render = $.render = function(str, args) {
		str = str.split("@",2);
	...
	// On Exit
	process.on('exit', $.unwatch = function() {
		try {
	...
	return $;
})();/**@preserve nTPL v.0.3.4;Copyright 2010, Fedor Indutny;Released under MIT license;Parts of code derived from jQuery JavaScript Library;Copyright (c) 2009 John Resig **/
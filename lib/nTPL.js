...
exports.parse = nTPL = (function() {
  ...
  *  @return {function(object): object} renderer function.
  */
  ...
  * @param {function(function(object): object): boolean} callback Callback for
  *       asynchronous mode.
  * @param {boolean} watch Watch file changes or not?.
  * @param {function(function(object): object): boolean} watchCallback When file
  *       is changed - this callback will be fired.
  * @return {function(object): object} renderer function.
  */
        ...
        try {
          ...
          i = scopedEval(['(function(', replVars, '){',
              'return (function($args,', _args.join(','), '){',
                  ...
                  'return $_.join("")',
              '})',
          '}).apply(this, $rep);'].join(''), $, namespace, $rep);
